...
trackx = x;
tracky = y;
sightRadius = 500; //detection radius if facing player
hearingRadius = 50; //detection radius if not facing player
escapeRadius = 800; //detection radius if chasing player

//where the sniper is aiming
aim = 90 + (-115*facing);